...
const Header = () => {
  ...
  >
    <div className="absolute inset-0 flex flex-col-reverse lg:flex-row mt-4 items-center justify-between sm:px-4 z-10 gap-4 sm:gap-8">
      {/* Text Section */}
      <div className="text-center lg:text-left lg:ml-5 lg:mt-10 sm:mb-8 mb-32 lg:mb-0">
        ...
        <p className="text-[#E8ECED] mt-4 font-comfortaa font-medium md:text-2xl" id="content">
          Your SaaS tool to Capture, Visualize and Analyze construction sites, at ease.
        </p>
        <button
