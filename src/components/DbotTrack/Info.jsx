...
function Info() {
  return (
    ...
    <div className="mb-32 mt-11 text-center">
      <div>
        <h2 className="text-center text-[#48304D] font-oswald font-semibold text-4xl mb-6">WHAT WE DO?</h2>
      </div>
      <div className="flex justify-center font-comfortaa font-light items-end">
        <p className="max-w-6xl">
          Dbot Track aims to streamline construction project management by enabling you to <span className='font-bold' >capture, visualize, and analyze</span> site data effortlessly.<br/> Our approach reduces the need for site visits, minimizes costly reworks and empowers you to make data-driven decisions for optimal <br/> project outcomes.
        </p>
      </div>
    </div>
    ...
    <div className="relative mb-36">
      <div className="flex flex-col sm:flex-row items-center justify-between p-4 relative mt-8 mb-8 bg-[#FDB347] fade-left-right h-auto sm:h-[calc(100vh-500px)]">
        <div className="text-center sm:text-left lg:mr-16 lg:ml-16">
          <p className="font-comfortaa text-[#48304D] font-bold">
          ...
          <div className="flex items-center gap-2 justify-center sm:justify-start my-3">
            <h2 className="text-4xl font-semibold font-oswald uppercase text-[#48304D]">Capture</h2>
          </div>
        </div>
    ...
    {/* Visualize Section */}
    <div className="flex flex-col-reverse sm:flex-row items-center justify-between p-4 relative my-8 mb-36 fade-right-left h-auto sm:h-[calc(100vh-500px)]">
      ...
      <div className="text-center sm:text-right lg:mr-16 lg:ml-16">
        ...
        <div className="flex items-center gap-2 justify-center sm:justify-end my-3">
          <h2 className="text-4xl font-semibold font-oswald uppercase text-[#48304D]">Visualize</h2>
        </div>
      </div>
    </div>
  
    {/* Analyze Section */}
    <div className="flex flex-col sm:flex-row items-center justify-between p-4 relative fade-left-right1 h-auto sm:h-[calc(100vh-500px)]">
      <div className="max-w-md text-center sm:text-left lg:mr-16 lg:ml-16">
        ...
        <div className="flex items-center gap-2 justify-center sm:justify-start my-3">
          <h2 className="text-4xl font-semibold font-oswald uppercase text-[#48304D]">Analyze</h2>
        </div>
      </div>
